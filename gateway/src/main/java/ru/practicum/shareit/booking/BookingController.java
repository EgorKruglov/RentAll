...
public class BookingController {
    ...
    @PostMapping
    public ResponseEntity<Object> bookItem(@RequestHeader(USER_HEADER) Integer userId,
    ...
    public ResponseEntity<Object> getBooking(@RequestHeader(USER_HEADER) Integer userId,
